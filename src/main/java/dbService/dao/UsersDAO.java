...
public class UsersDAO {
    ...
    public ArrayList<UsersDataSet> getList(String filter) throws SQLException {
        ArrayList<UsersDataSet> tmp = new ArrayList<>();

        return executor.execQueryList("select * from users where user_name like '%"+filter+"%'");
    }
    ...
    public void createTableSimple() throws SQLException {
        executor.execUpdate("create table users (id bigint auto_increment, user_name varchar(256), primary key (id))");
    }
